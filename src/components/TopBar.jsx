  ...
  return (
    <div className="flex-1 bg-slate-800/50 rounded-lg p-4 border border-white/10">
      <div className="flex items-center justify-between mb-2">
        ...
        {/* 右端圖標 */}
        <div className={`w-6 h-6 rounded-full flex items-center justify-center ${color.replace('text-', 'bg-').replace('-400', '-500/20')}`}>
...
function TopBar({ oxygen, power, bioWaste }) {
  return (
    <div 
      ...
      className="bg-slate-800 border-b border-white/10 p-4 relative z-30"
    >
